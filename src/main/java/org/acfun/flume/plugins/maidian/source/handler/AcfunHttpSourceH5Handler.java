...
public class AcfunHttpSourceH5Handler implements HTTPSourceHandler {
	
	
	protected static final Logger LOG = LoggerFactory.getLogger(AcfunHttpSourceH5Handler.class);
...
//		detailFieldsMap.put("100007", new String[] {});
//	}
	
	public static void main(String[] args) throws IOException{
		String stringFromFile = AcfunFileUtils.getStringFromFilePath("/Users/user/maidian-h5-json.conf");
